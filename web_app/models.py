...
class User(models.Model):
    ...
    'instagram_l' : models.URLField(max_length=255),
...
class Single_widget_area(models.Model):
    img = models.ImageField(upload_to ='blog_area_sw/') #single widget
    post_author = models.ForeignKey(User, on_delete=models.CASCADE)
    post_date = models.DateTimeField(auto_now_add=True)
    title = models.CharField(max_length=255)
    body = models.TextField()
    
class Instagram_item(models.Model):
    img = models.ImageField(upload_to ='instagram_items/')
    link = models.URLField(max_length=255)
    describe = models.CharField(max_length=255)
    
class Adress(models.Model):
    country = models.CharField(max_length=255)
    region_street = models.CharField(max_length=255)
